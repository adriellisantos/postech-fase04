...
dados = pd.read_csv('C:/Users/adrie/Downloads/Orçamento Salvalus_0725/dados_obesidade.csv')
...
#Título da página
st.markdown("<h1 style='text-align: center; '> Teste de Obesidade 📝 </h1> ", unsafe_allow_html = True)
